...
{
	[CustomEditor(typeof(TextReference), true)]
//	[CanEditMultipleObjects]
	public class TextReferenceEditor : UnityEditor.UI.GraphicEditor
	{
		...
		private void Init() {
			if( m_keyGUI == null ) {
				m_keyGUI = new StringTableKeyGUI();
		...
		static public void AddM10NText(MenuCommand menuCommand)
		{
			...
			TextReference lbl = go.AddComponent<TextReference>();
