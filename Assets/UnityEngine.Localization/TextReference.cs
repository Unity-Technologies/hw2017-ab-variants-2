...
public class TextReference : UnityEngine.UI.Text
{
	[SerializeField]
	private MultiLangStringReference m_reference;
	...
	public static bool displayKeyLabel {
		...
		set {
			...
			TextReference[] texts = GameObject.FindObjectsOfType<TextReference>();
			foreach(TextReference t in texts) {
	...
	public MultiLangStringReference stringReference {
		get {
			return m_reference;
		}
	}
